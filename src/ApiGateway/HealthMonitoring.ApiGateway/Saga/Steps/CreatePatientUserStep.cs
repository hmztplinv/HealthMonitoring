...
{
    public class CreatePatientUserStep : ISagaStep<CreatePatientUserRequest, Guid>
    {
        private readonly HttpClient _identityHttpClient;
        private readonly ILogger<CreatePatientUserStep> _logger;
        private Guid _createdUserId;

        public CreatePatientUserStep(
            IHttpClientFactory httpClientFactory,
            ILogger<CreatePatientUserStep> logger)
        {
        ...
        public async Task<Result<Guid>> ExecuteAsync(CreatePatientUserRequest data)
        {
            try
            {
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    // UserId'yi data nesnesine atama
